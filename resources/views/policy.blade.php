    ...
    <div class="col-md-10">
      ...
      <div class="card">
        <div class="card-header">
          <i class="material-icons">verified_user</i> Cookies (en)
        </div>
        <div class="card-body">
          ...
          <br>
          <br><b>How do we use cookies?</b><br>
          ...
          The cookie-related information is not used to identify you personally and the pattern data is fully under our control. These cookies are not used for any purpose other than those described here<br>
          <br><b>How to control cookies</b><br>
      ...
      <div class="card" style="margin-top: 20px;">
        <div class="card-header">
          <i class="material-icons">face</i> Note
        </div>
        <div class="card-body">
          Please note that most of these policies do not apply to us.<br>
          If you'd like this to be in your own language then feel free to use Google translate.<br>
